...
label1=Label(w, text='INVENTORY ', fg='white', bg='#272727') #decorate it 
label2=Label(w, text=' MANAGEMENT', fg='white', bg='#272727')
label1.configure(font=("Oswald", 27, "bold"))   #You need to install this font in your PC or try another one
label2.configure(font=("Oswald", 10, "bold"))
label1.place(x=110,y=70)
label2.place(x=160,y=110)

label3=Label(w, text='Loading...', fg='white', bg='#272727') #decorate it 
label3.configure(font=("Calibri", 11))
